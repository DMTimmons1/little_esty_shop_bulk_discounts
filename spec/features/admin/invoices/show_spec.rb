...
describe 'Admin Invoices Index Page' do
  ...
  describe 'User Story 8' do
    it 'shows the visitor of the admin invoice show page the total revenue from this invoice,
    and the total discounted revenue from this invoice which includes bulk discounts in the calculation' do
