...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "class methods" do
    before(:each) do
      ...
      @bd = BulkDiscount.create!(quantity: 9, discount: 20, merchant_id: @m1.id)
      @bd2 = BulkDiscount.create!(quantity: 5, discount: 10, merchant_id: @m1.id)
    end
    ...
    it 'applied_discount' do
      expect(@ii_1.applied_discount).to eq([@bd])
    end
  end
end
